 ...
 */
final class Version20250518170033 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("CREATE TYPE status_enum AS ENUM ('active', 'deleted', 'blocked', 'archived')");
        $this->addSql("CREATE TYPE user_role_enum AS ENUM ('ROLE_ADMIN', 'ROLE_MANAGER', 'ROLE_MEMBER', 'ROLE_API')");
        $this->addSql('CREATE TABLE "client_user" (id SERIAL NOT NULL, uuid UUID NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, telegram VARCHAR(100) DEFAULT NULL, status status_enum NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE file (id SERIAL NOT NULL, owner_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(1024) NOT NULL, mime_type VARCHAR(100) NOT NULL, size INT NOT NULL, extension VARCHAR(100) NOT NULL, hash VARCHAR(128) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_8C9F36107E3C61F9 ON file (owner_id)');
        $this->addSql('CREATE TABLE service (id SERIAL NOT NULL, service_type_id INT NOT NULL, uuid UUID NOT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, status status_enum NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE service_history (id SERIAL NOT NULL, service_id INT NOT NULL, creator_id INT NOT NULL, state_id INT NOT NULL, uuid UUID NOT NULL, note TEXT NOT NULL, status status_enum NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE service_state (id SERIAL NOT NULL, uuid UUID NOT NULL, name VARCHAR(50) NOT NULL, description TEXT NOT NULL, status status_enum NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE service_type (id SERIAL NOT NULL, uuid UUID NOT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, status status_enum NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, avatar_id INT DEFAULT NULL, uuid UUID NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, telegram VARCHAR(100) DEFAULT NULL, password VARCHAR(255) NOT NULL, role user_role_enum NOT NULL, status status_enum NOT NULL, is_verified BOOLEAN DEFAULT false NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
