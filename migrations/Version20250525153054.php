...
final class Version20250525153054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feedback_field (id SERIAL NOT NULL, feedback_id INT NOT NULL, uuid UUID NOT NULL, code VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, type VARCHAR(50) NOT NULL, required BOOLEAN NOT NULL, sort_order INT NOT NULL, is_hidden_by_default BOOLEAN NOT NULL, status VARCHAR(50) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_CF54DC3DD249A887 ON feedback_field (feedback_id)');
        $this->addSql('CREATE TABLE feedback_field_answer (id SERIAL NOT NULL, field_id INT NOT NULL, responder_id INT NOT NULL, value TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE feedback_field_dependence (id SERIAL NOT NULL, source_field_id INT NOT NULL, source_option_id INT NOT NULL, target_field_id INT NOT NULL, status VARCHAR(50) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_72F9D50F7173162 ON feedback_field_dependence (source_field_id)');
        $this->addSql('CREATE INDEX IDX_72F9D50FCF5A8EA1 ON feedback_field_dependence (source_option_id)');
        $this->addSql('CREATE INDEX IDX_72F9D50F9E9CD7D9 ON feedback_field_dependence (target_field_id)');
        $this->addSql('CREATE TABLE feedback_field_option (id SERIAL NOT NULL, field_id INT NOT NULL, label VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, sort_order INT NOT NULL, status VARCHAR(50) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE file (id SERIAL NOT NULL, owner_id INT NOT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(1024) NOT NULL, mime_type VARCHAR(100) NOT NULL, size INT NOT NULL, extension VARCHAR(100) NOT NULL, hash VARCHAR(128) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE feedback_field_dependence DROP CONSTRAINT FK_72F9D50F7173162');
        $this->addSql('ALTER TABLE feedback_field_dependence DROP CONSTRAINT FK_72F9D50FCF5A8EA1');
        $this->addSql('ALTER TABLE feedback_field_dependence DROP CONSTRAINT FK_72F9D50F9E9CD7D9');
        ...
        $this->addSql('DROP TABLE feedback_field_dependence');
